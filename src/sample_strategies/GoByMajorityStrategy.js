...
class GoByMajorityStrategy extends Strategy {
	
	constructor(name) {
		super((name)? name : "GoByMajorityStrategy");
	}
	 ...
	 * it then does whatever the other player did most 
...
module.exports = GoByMajorityStrategy;